...
export const metadata: Metadata = {
  ...
  title: 'Changelog | Whats91 Versions 1.0.2, 1.0.1, and 1.0.0',
  description:
    'Review Whats91 release notes for Versions 1.0.2, 1.0.1, and 1.0.0, dated 06 Jun 2026, 05 Jun 2026, and 03 Jun 2026.',
}
