...
const route = resolveRoutedDoc('messaging')
...
export default function MessagingPage() {
  ...
  return (
    <>
      <DocJsonLd categorySlug="messaging" />
      <DocumentationPage initialSectionId="messaging-overview" initialCategoryId="messaging" />
    </>
  )
}
