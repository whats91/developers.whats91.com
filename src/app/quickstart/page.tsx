...
const route = resolveRoutedDoc('getting-started', 'quick-start')
...
export default function QuickstartPage() {
  ...
  return (
    <>
      <DocJsonLd categorySlug="getting-started" sectionSlug="quick-start" />
      <DocumentationPage initialSectionId="quick-start" initialCategoryId="getting-started" />
    </>
  )
}
