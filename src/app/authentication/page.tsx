...
const route = resolveRoutedDoc('getting-started', 'authentication')
...
export default function AuthenticationPage() {
  ...
  return (
    <>
      <DocJsonLd categorySlug="getting-started" sectionSlug="authentication" />
      <DocumentationPage initialSectionId="authentication" initialCategoryId="getting-started" />
    </>
  )
}
