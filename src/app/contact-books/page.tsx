...
const route = resolveRoutedDoc('contact-book')

export const metadata: Metadata = buildDocMetadata(route)

export default function ContactBooksPage() {
  if (!route) notFound()

  return (
    <>
      <DocJsonLd categorySlug="contact-book" />
      <DocumentationPage initialSectionId="contact-book-list" initialCategoryId="contact-book" />
    </>
  )
}
