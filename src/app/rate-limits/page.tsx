...
const route = resolveRoutedDoc('getting-started', 'rate-limits')
...
export default function RateLimitsPage() {
  ...
  return (
    <>
      <DocJsonLd categorySlug="getting-started" sectionSlug="rate-limits" />
      <DocumentationPage initialSectionId="rate-limits" initialCategoryId="getting-started" />
    </>
  )
}
